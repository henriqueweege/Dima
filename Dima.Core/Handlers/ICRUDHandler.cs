...
public interface ICRUDHandler<TModel, in TCreateRequest, in TUpdateRequest, in TDeleteRequest, in TGetAllRequest> where TModel : BaseModel
{
    ...
    Task<Response<TModel>> Handle(long id, string email);
}
