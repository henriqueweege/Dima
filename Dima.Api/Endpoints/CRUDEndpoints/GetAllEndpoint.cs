...
{
    public class GetAllEndpoint<TModel, TCreateRequest, TUpdateRequest, TDeleteRequest, TGetAllRequest> : IEndpoint where TModel : BaseModel where TGetAllRequest : BaseRequest<TModel>
    {
        ...
        private static async Task<IResult> HandleAsync([FromBody]TGetAllRequest request, [FromServices] ICRUDHandler<TModel, TCreateRequest, TUpdateRequest, TDeleteRequest, TGetAllRequest> handler, ClaimsPrincipal user)
        {
