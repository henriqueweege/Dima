...
namespace Dima.Api.Data.Mappings
{
    public class ProductMappings : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(x => x.Slug).IsRequired(true).HasColumnType("VARCHAR").HasMaxLength(80);
            builder.Property(x => x.Desciption).IsRequired(false).HasColumnType("NVARCHAR").HasMaxLength(255);
